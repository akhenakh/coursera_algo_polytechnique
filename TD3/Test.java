...
public class Test {
    public static void testakh() {
        ...
        System.out.printf("dico.existeMot vide %s\n", dico.existeMot(""));
        System.out.printf("dico.existeMot la %s\n", dico.existeMot("la"));
        System.out.printf("dico.existeMot les %s\n", dico.existeMot("les"));
        System.out.printf("dico.existeMot sa %s\n", dico.existeMot("sa"));
        System.out.printf("dico.existeMot se %s\n", dico.existeMot("se"));
        System.out.printf("dico.existeMot lu %s\n", dico.existeMot("lu"));
        System.out.printf("dico.existeMot l %s\n", dico.existeMot("l"));
    }
  // Test existence l es a
  ...
  public static void test2() {
    ...
    // Test ajout
    public static void test2akh() {
        Dictionnaire dico =  new Dictionnaire();
        boolean b1 = dico.ajouteMot("le");
        boolean b2 = dico.ajouteMot("loup");
        System.out.printf("test2akh %s", dico.racine.trouveChar('l'));
        // System.out.println(dico);
    }
  // Test préfixe
